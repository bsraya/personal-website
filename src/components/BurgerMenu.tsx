...
export default function BurgerMenuSolid() {
  ...
  return (
    <div
      ref={containerRef}
      class="z-40 fixed top-4 right-4 rounded-xl border border-transparent burger-sticky-border md:relative md:top-auto md:right-auto md:rounded-none md:border-0 md:bg-transparent md:[animation:none]"
    >
      <button
