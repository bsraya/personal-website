...
Back two years ago, I made my first [Retrieval Augmented Generation](/works/vanilla-rag) system when models
were not that powerful as today, it only handled user prompts as inputs. 
Recently, I notice that Open-Sourced LLMs have significantly improved and I want to improve 
this vanilla RAG to a Multi-Modal one, capable of handling user prompts and images as input.
